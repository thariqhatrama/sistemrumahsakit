...
<head>
    ...
    <title>Lokasi Barang - RS Buah Hati</title>
...
<body id="page-top">
    ...
    <div id="wrapper">                
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Lokasi Barang</h1>                                          
                    <!-- DataTales Example -->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <?php
											$tempat = mysqli_query($con, "SELECT penyerahan.id_penyerahan, penyerahan.id_barang,
                                            SUM(penyerahan.jumlah) AS jumlah, penyerahan.id_unit,
                                            barang.*, unit.* FROM penyerahan
                                            INNER JOIN barang ON penyerahan.id_barang=barang.id_barang
                                            INNER JOIN unit ON penyerahan.id_unit=unit.id_unit GROUP BY penyerahan.id_unit, penyerahan.id_barang");
