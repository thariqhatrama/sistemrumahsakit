<?php
    ...
    $pinjam = mysqli_query($con,"UPDATE peminjaman SET tgl_pengembalian='$tgl_pengembalian', status='$status' WHERE id_pinjam='$id_pinjam'");    

    $updatestok = "UPDATE barang SET stok = '$stokakhir' WHERE id_barang = '$id_barang'";
    mysqli_query($con, $updatestok);
    
    header("location:../kembali/kembali.php");
    }    
?>